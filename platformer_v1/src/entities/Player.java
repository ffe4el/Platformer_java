...
//	 StatusBarUI
	...
	private void checkCointouch() { //동전에 닿았는지 확인
		playing.checkPotionTouched(hitbox);
	}

	private void checkTraptouch() { //트랩에 닿았는지 확인
		playing.checkSpikesTouched(this);

	}

	private void checkAttack() { //공격했는지 학인
	...
	private void loadAnimations() {
		BufferedImage img = LoadSave.GetSpriteAtlas(LoadSave.PLAYER); // JACK(LoadSave에 원본)
